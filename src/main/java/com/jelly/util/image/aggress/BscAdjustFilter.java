...
public class BscAdjustFilter extends AbstractBufferedImageOp{
    ...
    public BscAdjustFilter brightness(double brightness) {
    ...
    public BscAdjustFilter contrast(double contrast) {
    ...
    public BscAdjustFilter saturation(double saturation) {
        this.saturation = saturation;
        return this;
    }

    public BscAdjustFilter(double brightness, double contrast, double saturation) {
        this.brightness = brightness;
        this.contrast = contrast;
        this.saturation = saturation;
    }
    public BscAdjustFilter(){}
