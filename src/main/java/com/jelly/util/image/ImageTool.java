...
public class ImageTool implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        /**裁剪图片*/
        //bean.cut("D:\\opt\\", "/log/http_imgload2.jpg", 200, 100, 100, 100);
        /**压缩图片*/
        //bean.reduce("D:\\opt\\", "/log/http_imgload2.jpg", 500, 500, true);
        /**绘制水印*/
        //bean.water("D:\\opt\\log\\http_imgload2.jpg", bean.outputFile);
        /**旋转图片*/
        //bean.rotate("D:\\opt\\", "/log/http_imgload2.jpg", 90, null);
